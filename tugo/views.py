...
def home_view(request):
    ...
    return render(request,'tugo/index.html',{'products':products,'product_count_in_cart':product_count_in_cart})
...
def customer_signup_view(request):
    ...
    return render(request,'tugo/customersignup.html',context=mydict)
...
def add_to_cart_view(request,pk):
    ...
    response = render(request, 'tugo/index.html',{'products':products,'product_count_in_cart':product_count_in_cart})
...
def send_feedback_view(request):
    ...
    if request.method == 'POST':
        ...
        if feedbackForm.is_valid():
            feedbackForm.save()
            return render(request, 'tugo/feedback_sent.html')
    return render(request, 'tugo/send_feedback.html', {'feedbackForm':feedbackForm})
...
def payment_success_view(request):
    ...
    # there will be lot of redundant data in orders table...but its btugoe more complicated if we normalize it
...
def aboutus_view(request):
    return render(request,'tugo/aboutus.html')
...
def contactus_view(request):
    ...
    if request.method == 'POST':
        ...
        if sub.is_valid():
            ...
            return render(request, 'tugo/contactussuccess.html')
    return render(request, 'tugo/contactus.html', {'form':sub})
